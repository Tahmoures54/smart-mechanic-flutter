...
class AIDiagnosticService {
  ...
  String _buildPrompt(DiagnosticRequest req) {
    ...
    buf.writeln('هیچ سؤالی از کاربر نپرس؛ با همین اطلاعات پاسخ کامل بده و ابهام‌ها را با سناریوی «اگر…» پوشش بده.');
    buf.writeln();
    ...
    buf.writeln('۶. در پایان، با یک جملهٔ کوتاه کاربر را به ادامهٔ گفتگو تشویق کن.');
    buf.writeln();
