...
// ─────────────────────────────────────────────────────────────────────────────
// ── مدل تعمیرگاه (دیتابیس خود اپ + سازگاری با ساختار قبلی) ──
// ─────────────────────────────────────────────────────────────────────────────
class Garage {
  final String id;
  final String name;
...
/// سرویس تعمیرگاه‌ها از دیتابیس خود اپ (جایگزین Google Places)
class GarageService {
  ...
  Future<List<Garage>> findNearbyGarages(
    ...
    try {
      final params = <String, String>{
        ...
        if (config.keyword != null && config.keyword!.isNotEmpty)
          'q': config.keyword!,
