...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text('اعتبار ناکافی', style: TextStyle(color: theme.textTheme.titleLarge?.color)),
          ],
        ),
        content: Text(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            CircleAvatar(
              backgroundColor: theme.colorScheme.secondary,
              radius: 18,
              child: const Icon(Icons.support_agent_rounded, color: Colors.black87, size: 20),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  const Text('مکانیک هوشمند', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                  Text(
        ...
        actions: [
          Padding(
            ...
            child: Center(
              child: auth.isGolden
                  ? const Text('⭐ طلایی', style: TextStyle(fontSize: 12, color: Colors.amber, fontWeight: FontWeight.bold))
  ...
  Widget _buildCreditBadge(AuthProvider auth) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: hasCredit ? Colors.green.withAlpha(51) : Colors.red.withAlpha(51),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: hasCredit ? Colors.green : Colors.red, width: 1),
      ),
      child: Text(
        '${auth.credits} اعتبار',
        style: TextStyle(fontSize: 12, color: hasCredit ? Colors.green : Colors.red, fontWeight: FontWeight.bold),
      ),
    );
  }
  ...
  Widget _buildCarInfoBanner(ThemeData theme) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.directions_car_rounded, size: 16, color: theme.colorScheme.secondary),
          ...
          Text('$sentCount پیام ارسالی', style: TextStyle(fontSize: 11, color: theme.hintColor)),
        ],
      ),
    );
  }
  ...
  Widget _buildMessageList(ThemeData theme) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        if (index == _messages.length && _isTyping) return _buildTypingIndicator(theme);
        ...
        child: Align(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _bubbleBorder(msg, theme), width: 1),
              boxShadow: [
            ...
            child: Column(
              ...
              children: [
                ...
                if (msg.isAssistant && msg.diagnosticId != null) ...[
                  const SizedBox(height: 10),
                  RatingStars(diagnosticId: msg.diagnosticId, compact: true),
                ],
                ...
                Align(
                  ...
                  child: Text(
                    msg.timeLabel,
                    style: TextStyle(fontSize: 9, color: theme.hintColor.withAlpha(153)),
                  ),
                ),
  ...
  Widget _buildMessageContent(ChatMessage msg, ThemeData theme) {
    ...
    if (msg.isError) {
      return SelectableText(
        '⚠️ ${msg.text}',
        style: const TextStyle(fontSize: 13, height: 1.6, color: Colors.redAccent),
        textDirection: TextDirection.rtl,
      );
    }
    return MarkdownBody(
      ...
      styleSheet: MarkdownStyleSheet(
        p: TextStyle(fontSize: 14, height: 1.7, color: theme.textTheme.bodyLarge?.color),
        h1: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: theme.colorScheme.secondary, height: 2),
        h2: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: theme.colorScheme.secondary, height: 2),
        h3: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: theme.colorScheme.secondary, height: 1.8),
        listBullet: TextStyle(color: theme.colorScheme.secondary, fontSize: 14),
      ),
    );
  }
      ...
      builder: (ctx) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.copy_rounded, color: theme.colorScheme.primary),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
                ...
                builder: (_, __) {
                  ...
                  return Transform.scale(
                    ...
                    child: Container(
                      ...
                      height: 8,
                      decoration: BoxDecoration(
                        color: theme.colorScheme.secondary.withAlpha((opacity * 255).toInt()),
            ...
            const SizedBox(width: 10),
            Text('در حال تحلیل...', style: TextStyle(color: theme.hintColor, fontSize: 12)),
          ],
        ),
      ),
    );
        ...
        children: [
          ...
          IconButton(
            style: IconButton.styleFrom(
              backgroundColor: canSend ? theme.colorScheme.primary : theme.disabledColor,
            ),
            icon: _isTyping
