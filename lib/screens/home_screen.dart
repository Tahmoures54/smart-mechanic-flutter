  ...
  void _showNoCreditDialog() {
    showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'سهمیه رایگان این ماه تمام شده. بسته اعتبار یا اشتراک طلایی بگیرید.',
        ),
        actions: [
          TextButton(
        ...
        child: ListView(
          ...
          children: [
            if (auth.isAuthenticated)
              ListTile(
                ...
                subtitle: Text(
                  auth.remainingFree > 0
                      ? '${auth.remainingFree} عیب‌یابی رایگان این ماه'
                      : 'برای شارژ به فروشگاه بروید',
                ),
                trailing: TextButton(
                  onPressed: () => Navigator.push(
                    context,
              ...
              ListTile(
                title: const Text(
                  'با ورود تا ۲ عیب‌یابی رایگان در ماه + اعتبار هدیه',
                ),
                trailing: TextButton(
                  onPressed: () => Navigator.push(
                    context,
            ...
            TextButton(
              ...
              child: Text(
                _isCustomCar ? 'بازگشت به لیست' : 'خودروی من در لیست نیست',
              ),
            ),
            const SizedBox(height: 16),
            const Text(
